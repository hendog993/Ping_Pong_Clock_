...
/* Max time values for 24 hour time */
#define MAX_VAL_DIGIT_1 2 
#define MAX_VAL_DIGIT_2 10
#define MAX_VAL_DIGIT_3 5
#define MAX_VAL_DIGIT_4 10

/* Background Color Definitions */
#define BACKGROUND_RED_COLOR 0 
#define BACKGROUND_GREEN_COLOR 0 
#define BACKGROUND_BLUE_COLOR 255 
...
#define NUMBER_RED_COLOR 255 
#define NUMBER_GREEN_COLOR 165
...
/* LED Assignments for digits. Array is structured nums[numbers 1-9][led assignment] */
